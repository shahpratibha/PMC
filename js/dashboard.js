...
//         // Ensure that features are present and is an array
...
//         var processedFeatures = geojsonData.features.flatMap(function (feature) {
//             if (feature && feature.geometry) {
//                 switch (feature.geometry.type) {
//                     case 'Polygon':
//                     case 'MultiPolygon':
//                         // Calculate the centroid for Polygons and MultiPolygons
...
//                         return [feature];
//                     case 'MultiPoint':
//                         // Convert each point in MultiPoint to individual Point features
...
//                         // Use lines as is (can ignore for clustering)
//                         return [];
//                     default:
...
//                 }
//             }
//             return []; // Return an empty array if the feature does not meet criteria
//         });

//         // Add processed features to the map as markers
//         L.geoJSON(processedFeatures, {
//             pointToLayer: function (feature, latlng) {
//                 if (feature.geometry.type === 'Point') {
//                     return L.marker(latlng);
//                 }
//                 return null; // Return null for non-point features here
//             }
//         }).addTo(markers);
...
//     "Slum": "#bbb",
//     "City Engineer Office": "#000000",
//     "Education Department": "#000000",
//     "Environment": "#000000",
//     "Project Work": "#5639b3",
// "Solid waste Managment": "49a44c",
...
//     var color = departmentColors[department] || 'green'; // Default to black if department color is not found
