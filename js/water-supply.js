...
if (workType == "New") {
  ...
  customDrawControls.onAdd = function (map) {
    ...
    div.innerHTML =
      '<button class="draw_feature"  style=" background-color:white; padding: 5px ;" title="Draw New Feature"> <img src="png/006-drawing.png" style="width: 20px; height: 20px;"></button>';
